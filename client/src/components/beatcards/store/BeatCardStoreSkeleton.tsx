    ...
    return (
        <SkeletonTheme baseColor="#1e1e1e" highlightColor="#2c2c2c">
            <div className="bg-card-bg text-white rounded-xl shadow-md p-3 sm:p-4 flex gap-3 sm:gap-4 w-full max-w-4xl mx-auto overflow-hidden h-39 sm:h-[186.75px]">
                ...
                {/* RIGHT */}
                <div className="flex flex-col justify-between flex-1 min-w-0 h-33 sm:h-[154.75px]">
                    {/* Title + Key/BPM — EXACT 38px on mobile */}
                    <div className="min-w-0 h-9.5 sm:h-[44.75px] flex flex-col justify-between">
                    ...
                    <div className="min-w-0 flex items-center gap-3 sm:gap-4 mt-2 h-12 sm:h-16">
                    ...
                    <div className="flex items-center gap-3 mt-2 h-7.5">
