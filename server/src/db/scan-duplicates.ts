 ...
 */
async function scanDuplicatesWithin(
    dir: string,
    label: string
    ...
    const duplicates = new Map<string, FileHash[]>();
 ...
 */
async function scanDuplicatesBetween(
    dir1: string,
    label1: string,
    dir2: string,
    label2: string
): Promise<Map<string, { used: FileHash[]; unused: FileHash[] }>> {
    ...
    const hashMap1 = new Map<string, FileHash[]>();
    ...
    const sharedDuplicates = new Map<string, { used: FileHash[]; unused: FileHash[] }>();
...
function generateReport(
    withinUnused: Map<string, FileHash[]>,
    betweenUsedAndUnused: Map<string, { used: FileHash[]; unused: FileHash[] }>
) {
    console.log('\n' + '='.repeat(80));
