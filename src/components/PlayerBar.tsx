    ...
    <div className="fixed bottom-0 left-0 w-full bg-[#121212] text-white shadow-t z-50">
      ...
      <div className="flex items-center gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-4 mx-auto">
          <button className="p-1 hover:opacity-75 cursor-pointer">
        ...
        {currentBeat && (
          <div className="flex items-center gap-3 pl-4">
            ...
            <button className="flex items-center gap-2 border border-brand-yellow text-brand-yellow hover:bg-brand-yellow cursor-pointer hover:text-black px-3 py-1 rounded-full text-sm transition">
              <FaCartShopping />
